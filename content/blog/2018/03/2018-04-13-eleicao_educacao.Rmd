...
```{r serie_br, fig.cap = 'Valores mensais de transferências. A série localizada no canto superior do gráfico representa as médias móveis, com janela de 12 meses, relativas às séries observadas.', fig.width = 10}
